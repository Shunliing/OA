			...
			<c:choose>
				<c:when test="right==3">
					<table cellpadding="0" width="100%" align="center"
						style="text-align: center; margin: 55px auto;">

						<tr>
							<td align="left"
								style="background: url(images/dashboard/zongjingli.png) no-repeat center; width: 100px; height: 150px; background-color: #f7f7f7;"><a
								href="viewAlarm.action?deptNumber=10000"><img
									style="width: 20px; height: 30px;" id="zongjingli"
									src="images/dashboard/ok.png">总经理</a></td>
							<td align="left"
								style="background: url(images/dashboard/caiwubu.png) no-repeat center; width: 128px; height: 150px; background-color: #f7f7f7;"><a
								href="viewAlarm.action?deptNumber=10004"><img
									style="width: 20px; height: 30px;" id="caiwu"
									src="images/dashboard/ok.png">财务部</a></td>

							<td align="left"
								style="background: url(images/dashboard/gongguan.png) no-repeat center; width: 128px; height: 150px; background-color: #f7f7f7;"><a
								href="viewAlarm.action?deptNumber=10003"><img
									style="width: 20px; height: 30px;" id="gongguan"
									src="images/dashboard/ok.png">公关部</a></td>
						</tr>
						...
						<tr>
							<td align="left"
								style="background: url(images/dashboard/jishu.png) no-repeat center; width: 128px; height: 150px; background-color: #f7f7f7;"><a
								href="viewAlarm.action?deptNumber=10002"><img
									style="width: 20px; height: 30px;" id="jishu"
									src="images/dashboard/ok.png">技术部</a></td>
							<td align="left"
								style="background: url(images/dashboard/shichangbu.png) no-repeat center; width: 128px; height: 150px; background-color: #f7f7f7;"><a
								href="viewAlarm.action?deptNumber=10001"><img
									style="width: 20px; height: 30px;" id="shichang"
									src="images/dashboard/ok.png">市场部</a></td>

							<td align="left"
								style="background: url(images/dashboard/houqin.png) no-repeat center; width: 128px; height: 150px; background-color: #f7f7f7;"><a
								href="viewAlarm.action?deptNumber=10005"><img
									style="width: 20px; height: 30px;" id="houqin"
									src="images/dashboard/ok.png">后勤部</td>
						</tr>
					</table>
				</c:when>
				<c:otherwise>
						...
						<tr>
							<td style="width: 33%">
								<table bgcolor="#f7f7f7" style="color: #333;">
									<tr>
										<td rowspan="2"><img
											src="images/dashboard/zongjingli.png"></td>
							...
							<td style="width: 34%">
								<table bgcolor="#f7f7f7" style="color: #333;">
									...
									<tr>
										<td>公关部有这一套合理的工作模式。每周有固定的例会时间，总结上周的工作，并布置下周工作，集体讨论遇到各种问题
										</td>
									</tr>
								</table>
							</td>
						...
						<tr>
							...
							<td>
								<table bgcolor="#f7f7f7" style="color: #333;">
									<tr>
										<td rowspan="2"><img
											src="images/dashboard/shichangbu.png"></td>
										<td style="color: #154ba0; font-size: 14px; height: 30px;">市场部</td>
									</tr>
									<tr>
										<td>
											市场部是为实现企业的经营目标制定策略的部门，而销售部是落实策略并具体执行销售计划以完成企业经营目标的部门。</td>
									</tr>
								</table>
							</td>
							<td>
								<table bgcolor="#f7f7f7" style="color: #333;">
									...
									<tr>
										<td>根据上级指示精神结合我院实际，制定总务科管理规章制度和学期工作计划，并负责组织实施，检查落实执行情况。</td>
									</tr>
								</table>
							</td>
						</tr>
